from trainer.trainer import ABSTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_dropout", type=strtobool, default=True, help="batchnormを使うか")
    parser.add_argument("--use_batchnorm", type=strtobool, default=True, help="dropoutを使うか")
